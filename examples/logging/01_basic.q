...
puts("\n=== Log Levels ===")
puts("DEBUG:    " .. log.DEBUG._str() .. "  - Detailed diagnostic info")
puts("INFO:     " .. log.INFO._str() .. "  - General informational messages")
puts("WARNING:  " .. log.WARNING._str() .. "  - Warning messages")
puts("ERROR:    " .. log.ERROR._str() .. "  - Error messages")
puts("CRITICAL: " .. log.CRITICAL._str() .. " - Critical errors")
