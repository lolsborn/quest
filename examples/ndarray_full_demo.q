...
puts("  A + B = " .. added.to_array().str())
puts("  A * B (element-wise) = " .. multiplied.to_array().str())
puts("")
...
puts("  A * 2.5 = " .. scaled.to_array().str())
puts("  A + 10 = " .. shifted.to_array().str())
puts("")
...
puts("  A^T = " .. transposed.to_array().str())
puts("  A · A^T = " .. matmul.to_array().str())
puts("")

# 7. Aggregations
puts("7. Aggregations:")
let data = np.array([[1, 2, 3], [4, 5, 6]])
puts("  sum() = " .. data.sum().str())
puts("  mean() = " .. data.mean().str())
puts("  min() = " .. data.min().str())
puts("  max() = " .. data.max().str())
puts("  std() = " .. data.std().str())
puts("  var() = " .. data.var().str())
puts("")
...
puts("  sum(axis=0) = " .. col_sum.to_array().str())
puts("  mean(axis=1) = " .. row_mean.to_array().str())
puts("")
...
puts("  1D -> 2D -> 1D")
puts("  Original: " .. v.shape().str())
puts("  Reshaped: " .. reshaped.shape().str())
puts("  Flattened: " .. flattened.shape().str())
puts("")
...
puts("  NDArray -> Array: " .. quest_array.str())
...
puts("  Mean: " .. mean_val.str())
puts("  Std: " .. std_val.str())
