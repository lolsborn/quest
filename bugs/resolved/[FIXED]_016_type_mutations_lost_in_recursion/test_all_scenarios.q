...
c1.increment()
puts("  Result: " .. c1.count.str() .. " (expected: 1)")
...
mutate_once(c2)
puts("  Result: " .. c2.count.str() .. " (expected: 1)")
...
puts("  Result: " .. c3.count.str() .. " (expected: 3)")
...
mutate_a(c4)
puts("  Result: " .. c4.count.str() .. " (expected: 2)")
...
add_via_func(c5, 5)
puts("  Result: " .. c5.count.str() .. " (expected: 5)")
...
add_two(c6a, c6b)
puts("  c6a Result: " .. c6a.count.str() .. " (expected: 1)")
puts("  c6b Result: " .. c6b.count.str() .. " (expected: 1)")
...
let arr = [c7]
arr[0].increment()
puts("  Original c7: " .. c7.count.str() .. " (expected: 1)")
puts("  Array[0]: " .. arr[0].count.str() .. " (expected: 1)")
...
let d = {"counter": c8}
d["counter"].increment()
puts("  Original c8: " .. c8.count.str() .. " (expected: 1)")
puts("  Dict value: " .. d["counter"].count.str() .. " (expected: 1)")
...
puts("  Original c9: " .. c9.count.str() .. " (expected: 1)")
puts("  Returned: " .. c9_returned.count.str() .. " (expected: 1)")
...
puts("  Counter: " .. c10.count.str() .. " (expected: 4)")
puts("  Return value: " .. result10.str() .. " (expected: 4)")
...
puts("Passed: " .. passed.str() .. "/" .. total.str())
if passed == total
    puts("✅ All tests passed!")
else
    puts("❌ " .. (total - passed).str() .. " test(s) failed")
end
