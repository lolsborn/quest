...
const documentModuleAliases: Map<string, Map<string, string>> = new Map();
...
// Module methods
const MODULE_METHODS: Record<string, Array<{ name: string; doc: string }>> = {
  'std/math': [
...
function extractModuleAliases(text: string): Map<string, string> {
