#!/usr/bin/env quest
# Brainfuck interpreter in Quest
...
# Character/byte conversion now uses built-in chr() and ord() functions!

# Parser - use array-based approach instead of type with mutable state
...
# Printer type - must use type for mutable state (dicts are copied)
type Printer
  sum1: Int
  sum2: Int
  quiet: Bool
...
# Execute brainfuck - types have reference semantics so printer mutates directly
