...
test.describe("String isdecimal()", fun ()
    ...
    test.it("returns false for non-decimal strings", fun ()
        test.assert(not "12.3".isdecimal(), "12.3 should not be decimal (has period)")
        test.assert(not "abc".isdecimal(), "abc should not be decimal")
        test.assert(not "12a".isdecimal(), "12a should not be decimal")
        test.assert(not "".isdecimal(), "empty string should not be decimal")
    end)

    test.it("returns false for negative numbers", fun ()
        test.assert(not "-123".isdecimal(), "-123 should not be decimal (has sign)")
    end)
end)
...
test.describe("String istitle()", fun ()
    ...
    test.it("returns false for non-title case strings", fun ()
        test.assert(not "hello world".istitle(), "hello world is not title case")
        test.assert(not "Hello world".istitle(), "Hello world is not title case")
        test.assert(not "HELLO WORLD".istitle(), "HELLO WORLD is not title case")
        test.assert(not "hELLO".istitle(), "hELLO is not title case")
        test.assert(not "".istitle(), "empty string is not title case")
    end)
...
test.describe("String expandtabs()", fun ()
    test.it("expands tabs with default size 8", fun ()
        ...
        test.assert(not expanded.count("\t"), "should not contain tabs")
    end)
