...
test.describe("set.to_array", fun ()
    test.it("converts to sorted array", fun ()
        ...
        test.assert_eq(arr[0], 1, nil)
        test.assert_eq(arr[1], 2, nil)
        test.assert_eq(arr[2], 3, nil)
    end)

    test.it("works with strings", fun ()
        let s = Set.new(["banana", "apple", "cherry"])
        let arr = s.to_array()
        test.assert_eq(arr[0], "apple", nil)
        test.assert_eq(arr[1], "banana", nil)
        test.assert_eq(arr[2], "cherry", nil)
    end)
end)
