...
test.describe("Static methods with defaults", fun ()
    ...
    test.it("defaults in static factory methods", fun ()
        ...
        test.assert_eq(p1.x, 0, nil)
        test.assert_eq(p1.y, 0, nil)
        test.assert_eq(p2.x, 5, nil)
        test.assert_eq(p2.y, 0, nil)
        test.assert_eq(p3.x, 5, nil)
        test.assert_eq(p3.y, 10, nil)
    end)
end)
