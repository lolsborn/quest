...
module("QEP-003: Function Decorators")
...
describe("Basic Decorators", fun ()
  it("applies single decorator", fun ()
    @uppercase_decorator
    fun greet(name)
      return "hello, " .. name
    end
  ...
  it("decorator preserves function name", fun ()
    @uppercase_decorator
    fun my_function(x)
      return x
    end

    assert_eq(my_function._name(), "my_function")
  end)

  it("decorator with no arguments works", fun ()
    @exclamation_decorator
    fun announce(msg)
      return msg
    end

    assert_eq(announce("hello"), "hello!!!")
  end)

  it("decorator forwards multiple arguments", fun ()
    @uppercase_decorator
    fun concat(a, b, c)
      return a .. " " .. b .. " " .. c
    end

    assert_eq(concat("one", "two", "three"), "ONE TWO THREE")
  end)
end)
...
describe("Stacked Decorators", fun ()
  it("applies two decorators (bottom to top)", fun ()
    @exclamation_decorator
    @uppercase_decorator
    fun say_hello(name)
      return "hello, " .. name
  ...
  it("applies three decorators", fun ()
  ...
  it("decorator order matters", fun ()
    ...
    assert_eq(f1("test"), "TEST!!!")
    assert_eq(f2("test"), "TEST!!!")  # !!! gets uppercased too
  end)
end)
...
describe("Decorators with Arguments", fun ()
  it("accepts named arguments", fun ()
    @prefix_decorator(prefix: "Dr. ")
    fun name(n)
      return n
    end

    assert_eq(name("Smith"), "Dr. Smith")
  end)

  it("different instances have different configs", fun ()
    ...
    assert_eq(mister("Jones"), "Mr. Jones")
    assert_eq(missus("Smith"), "Mrs. Smith")
  end)

  it("numeric decorator arguments work", fun ()
...
describe("Decorators with Varargs", fun ()
  it("forwards varargs to decorated function", fun ()
    @uppercase_decorator
    fun join(*words)
      let result = ""
      for word in words
  ...
  it("forwards mixed args and varargs", fun ()
    @uppercase_decorator
    ...
    assert_eq(greet_many("Hello", "Alice", "Bob"), "HELLO ALICE BOB")
  end)
end)
...
describe("Edge Cases", fun ()
  it("decorator on zero-arg function", fun ()
    @exclamation_decorator
    fun no_args()
      return "test"
    end

    assert_eq(no_args(), "test!!!")
  end)

  it("decorator returns nil", fun ()
    type nil_decorator
      func
