...
describe("gzip.compress and gzip.decompress", fun ()
  ...
  it("supports different compression levels", fun ()
    ...
    assert_eq(gzip.decompress(fast).decode("utf-8"), data)
    assert_eq(gzip.decompress(default).decode("utf-8"), data)
    assert_eq(gzip.decompress(best).decode("utf-8"), data)
  end)
  ...
  it("level 0 produces valid gzip", fun ()
    let data = "test data"
