...
test.describe("bzip2.compress and bzip2.decompress", fun ()
    ...
    test.it("supports different compression levels", fun ()
        ...
        test.assert_eq(bzip2.decompress(fast).decode("utf-8"), data, nil)
        test.assert_eq(bzip2.decompress(default).decode("utf-8"), data, nil)
        test.assert_eq(bzip2.decompress(best).decode("utf-8"), data, nil)
    end)
