...
puts("MD5('Hello, World!') = ", md5_result)
puts("Expected: 8cda2aacb2e63f99d416d3e4d82e3295")

puts()
puts("=== SHA-1 Hash ===")
let sha1_result = hash.sha1("Hello, World!")
puts("SHA-1('Hello, World!') = ", sha1_result)
puts("Expected: 4ca9653095931ef15cb6b02d72f621e1bcbb856b")

puts()
puts("=== SHA-256 Hash ===")
let sha256_result = hash.sha256("Hello, World!")
puts("SHA-256('Hello, World!') = ", sha256_result)
puts("Expected: ae97eca8f8ae1672bcc5c79e3fbafd8ee86f65f775e2250a291d3788b7a8af95")

puts()
puts("=== SHA-512 Hash ===")
let sha512_result = hash.sha512("Hello, World!")
puts("SHA-512('Hello, World!') = ")
puts(sha512_result)
...
puts()
puts("=== CRC32 Checksum ===")
let crc_result = hash.crc32("Hello, World!")
puts("CRC32('Hello, World!') = ", crc_result)
