...
test.describe("Element-wise operations", fun ()
    ...
    test.it("subtracts two arrays", fun ()
        ...
        let result = c.to_array()
        test.assert_eq(result[0][0], 9.0, nil)
        test.assert_eq(result[1][1], 36.0, nil)
    end)
    ...
    test.it("divides two arrays element-wise", fun ()
        ...
        let result = c.to_array()
        test.assert_eq(result[0][0], 5.0, nil)
        test.assert_eq(result[0][1], 5.0, nil)
        test.assert_eq(result[1][0], 6.0, nil)
        test.assert_eq(result[1][1], 5.0, nil)
    end)
...
test.describe("Scalar operations", fun ()
    test.it("adds scalar to array", fun ()
        ...
        test.assert_eq(result[0][0], 11.0, nil)
        test.assert_eq(result[1][1], 14.0, nil)
    end)
    ...
    test.it("subtracts scalar from array", fun ()
        ...
        let result = b.to_array()
        test.assert_eq(result[0][0], 5.0, nil)
        test.assert_eq(result[1][1], 35.0, nil)
    end)
    ...
    test.it("multiplies array by scalar", fun ()
        ...
        let result = b.to_array()
        test.assert_eq(result[0][0], 2.5, nil)
        test.assert_eq(result[0][1], 5.0, nil)
        test.assert_eq(result[1][0], 7.5, nil)
        test.assert_eq(result[1][1], 10.0, nil)
    end)
    ...
    test.it("divides array by scalar", fun ()
        ...
        let result = b.to_array()
        test.assert_eq(result[0][0], 1.0, nil)
        test.assert_eq(result[0][1], 2.0, nil)
        test.assert_eq(result[1][0], 3.0, nil)
        test.assert_eq(result[1][1], 4.0, nil)
    end)
end)
...
test.describe("Standard deviation and variance", fun ()
    test.it("computes std of all elements", fun ()
        ...
        test.assert(std_val > 1.0, nil)
        test.assert(std_val < 1.5, nil)
    end)
    ...
    test.it("computes variance of all elements", fun ()
        ...
        test.assert_eq(var_val, 1.25, nil)
    end)
    ...
    test.it("computes std along axis", fun ()
        ...
        test.assert_eq(result[0], 0.0, nil)
    end)
...
test.describe("Utility methods", fun ()
    test.it("flattens multi-dimensional array", fun ()
        ...
        test.assert_eq(result[0], 1.0, nil)
        test.assert_eq(result[5], 6.0, nil)
    end)
    ...
    test.it("converts to nested Quest arrays", fun ()
        ...
        test.assert_eq(arr[0][0], 1.0, nil)
        test.assert_eq(arr[0][1], 2.0, nil)
        test.assert_eq(arr[1][0], 3.0, nil)
        test.assert_eq(arr[1][1], 4.0, nil)
    end)
    ...
    test.it("converts 1D array to Quest array", fun ()
        ...
        test.assert_eq(arr[0], 1.0, nil)
        test.assert_eq(arr[4], 5.0, nil)
    end)
    ...
    test.it("converts 3D array to nested arrays", fun ()
        ...
        test.assert_eq(arr[0][0][0], 1.0, nil)
        test.assert_eq(arr[1][1][1], 8.0, nil)
    end)
end)
